...
export const CALCULATIONS: Partial<Record<Category, Formula[]>> = {
  ...
  area: [
    ...
    },
    {
      ...
      expression: 'A = ½(a + b) × h',
      inputs: [
        { id: 'a', label: 'Parallel side a', unit: 'm', placeholder: '5', min: 0 },
  ...
  weight: [
    {
      ...
      inputs: [
        ...
        { id: 'h', label: 'Height', unit: 'm',  placeholder: '1.75', min: 0, step: 0.01 },
      ],
    ...
    },
    {
      ...
      expression: 'ρ = m / V',
      inputs: [
        { id: 'm', label: 'Mass',   unit: 'kg', placeholder: '500',  min: 0 },
        { id: 'V', label: 'Volume', unit: 'm³', placeholder: '0.5',  min: 0, step: 0.001 },
      ],
  ...
  temperature: [
    {
      ...
      expression: 'Q = m × c × ΔT',
      inputs: [
        { id: 'm',  label: 'Mass',          unit: 'kg',     placeholder: '1',    min: 0 },
    ...
    },
    {
      ...
      inputs: [
        { id: 'L', label: 'Original length L₀', unit: 'm',    placeholder: '10',    min: 0 },
  ...
  speed: [
    ...
    },
    {
      ...
      expression: 'a = (v₂ − v₁) / t',
      inputs: [
        { id: 'v1', label: 'Initial speed v₁', unit: 'm/s', placeholder: '0' },
        { id: 'v2', label: 'Final speed v₂',   unit: 'm/s', placeholder: '30' },
        { id: 't',  label: 'Time',             unit: 's',   placeholder: '10', min: 0 },
      ],
  ...
  angle: [
    ...
    },
    {
      ...
      inputs: [
        { id: 'a', label: 'Side a', unit: 'm', placeholder: '5', min: 0 },
  ...
  pressure: [
    ...
    },
    {
      ...
      expression: 'P₂ = P₁V₁ / V₂',
      inputs: [
        { id: 'P1', label: 'Initial pressure P₁', unit: 'Pa',  placeholder: '101325', min: 0 },
    ...
    },
    {
      ...
      expression: 'F₂ = F₁ × A₂ / A₁',
      inputs: [
        { id: 'F1', label: 'Input force F₁', unit: 'N',  placeholder: '100',  min: 0 },
  ...
  energy: [
    ...
    },
    {
      ...
      inputs: [
        { id: 'F', label: 'Force',    unit: 'N', placeholder: '50', min: 0 },
  ...
  power: [
    ...
    },
    {
      ...
      inputs: [
        { id: 'Po', label: 'Output power', unit: 'W', placeholder: '800',  min: 0 },
        { id: 'Pi', label: 'Input power',  unit: 'W', placeholder: '1000', min: 0 },
      ],
  ...
  force: [
    ...
    },
    {
      ...
      inputs: [
        { id: 'F', label: 'Force',     unit: 'N', placeholder: '100', min: 0 },
        { id: 'r', label: 'Lever arm', unit: 'm', placeholder: '0.5', min: 0, step: 0.01 },
  ...
  fuel: [
    ...
    },
    {
      ...
      inputs: [
        { id: 't', label: 'Tank size',  unit: 'L',   placeholder: '50',   min: 0 },
        { id: 'p', label: 'Fuel price', unit: '$/L', placeholder: '1.80', min: 0, step: 0.01 },
      ],
