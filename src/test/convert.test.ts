...
describe('convert - voltage', () => {
  it('1 kV == 1000 V', () => {
    expect(convert(1, 'kV', 'V', 'voltage')).toBeCloseTo(1000, 5);
  });

  it('1 V == 1000 mV', () => {
    expect(convert(1, 'V', 'mV', 'voltage')).toBeCloseTo(1000, 5);
  });
});

describe('convert - current', () => {
  it('1 A == 1000 mA', () => {
    expect(convert(1, 'A', 'mA', 'current')).toBeCloseTo(1000, 5);
  });
});

describe('convert - resistance', () => {
  it('1 kΩ == 1000 Ω', () => {
    expect(convert(1, 'kΩ', 'Ω', 'resistance')).toBeCloseTo(1000, 5);
  });
});

describe('convert - capacitance', () => {
  it('1 μF == 1000 nF', () => {
    expect(convert(1, 'μF', 'nF', 'capacitance')).toBeCloseTo(1000, 5);
  });
});

describe('convert - charge', () => {
  it('1 Ah == 3600 C', () => {
    expect(convert(1, 'Ah', 'C', 'charge')).toBeCloseTo(3600, 5);
  });

  it('1 mAh == 3.6 C', () => {
    expect(convert(1, 'mAh', 'C', 'charge')).toBeCloseTo(3.6, 5);
  });

  it('3000 mAh == 3 Ah', () => {
    expect(convert(3000, 'mAh', 'Ah', 'charge')).toBeCloseTo(3, 5);
  });
});
